...
plot_country <- function(df, country_name, indicator) {
  ...
  # Vẽ biểu đồ
    p <- ggplot(data =  df_sub, aes(x = year, y = .data[[indicator]])) +
